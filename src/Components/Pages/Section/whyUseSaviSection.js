...
const WhySaviSection = () => {
  return (
    <section className='why-savi-section bg-light py-5'>
      <Container>
        <h2 className='why-use-savi text-center mb-4'>Why use Savi?</h2>
        <Row className='justify-content-center'>
          <Col xs={12} md={4} className='mb-4'>
            <div className='whyUseSavi-feature d-flex flex-column align-items-center'>
              <div className='saviIcon-div rounded-circle d-flex justify-content-center align-items-center'>
                <img src={exchangeIcon} alt='exchangeIcon' className='App-logo' />
              </div>
              <h4 className='whySavi-title font-weight-bold mt-3'>Contribution Analytics</h4>
              <div className='whySaviDescription-div'>
                <h6 className='whySavi-description font-weight-light'>
          ...
          <Col xs={12} md={4} className='mb-4'>
            <div className='whyUseSavi-feature d-flex flex-column align-items-center'>
              ...
              <h4 className='whySavi-title font-weight-bold mt-3'>Wallet Integration</h4>
              <div className='whySaviDescription-div'>
                <h6 className='whySavi-description font-weight-light'>
          ...
          <Col xs={12} md={4} className='mb-4'>
            <div className='whyUseSavi-feature d-flex flex-column align-items-center'>
              ...
              <h4 className='whySavi-title font-weight-bold mt-3'>Notifications and Reminders</h4>
              <div className='whySaviDescription-div'>
                <h6 className='whySavi-description font-weight-light'>
