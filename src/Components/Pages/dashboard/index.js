...
import DatePicker from "../../../Assests/svg/DatePicker.svg";
...
export const Dashboard = () => {
  ...
  return (
    <>
      {isLoading || isLoadingWallet ? "" : null}
      <Flex flexDir="column">
        {isBanner && ""}
